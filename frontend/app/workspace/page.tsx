          ...
          {selectedFile ? (
            ...
            <div className="flex-1 flex items-center justify-center bg-zinc-950 relative overflow-hidden">
               ...
               <div className="relative z-10 flex flex-col items-center">
                 <div className="w-24 h-24 border border-dashed border-zinc-800 rounded-full flex items-center justify-center mb-8 animate-[spin_10s_linear_infinite]">
                   <div className="w-16 h-16 border border-dashed border-zinc-800 rounded-full flex items-center justify-center">
                     <div className="w-2 h-2 bg-indigo-500 rounded-full animate-pulse" />
                   </div>
                 </div>
                 <h2 className="text-zinc-500 font-mono text-xs tracking-[0.3em] mb-2">SYSTEM STANDBY</h2>
                 <p className="text-zinc-700 font-mono text-[10px]">AWAITING INPUT SIGNAL</p>
                 
                 <div className="mt-12 flex gap-4">
                   <div className="flex items-center gap-2 text-zinc-600 text-xs font-mono">
                     <Command className="h-3 w-3" /> <span className="bg-zinc-900 px-1.5 py-0.5 rounded border border-white/5">P</span> <span>Search Files</span>
                   </div>
                 </div>
               </div>
            </div>
